                                    ...
                                    <div className="flex flex-col grow shrink-0 self-end mt-12 basis-0 w-fit max-md:mt-10 max-md:max-w-full">
                                        ...
                                        <div className="flex flex-col p-12 mt-6 bg-white rounded-xl max-md:px-5 max-md:max-w-full">
                                                ...
                                                <div className="flex flex-col flex-1 justify-center py-px text-4xl font-bold leading-10">
                                                    <div className="flex gap-2 px-1 items-start">
                                                        ...
                                                        <div className="my-auto mb-6 mr-5">
                                                            <span className="text-6xl leading-[78px]">4.9</span>/5.0
                                                        </div>
                                                        <div className="flex flex-col grow shrink-0 basis-0 w-fit">
                                                            <div className="text-3xl font-bold">Kemasan Sterofoam</div>
                                                            <div className="mt-0.5 text-lg">Rp 200.000/40 Kg</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="flex gap-5 justify-between py-2.5 pr-1 pl-2.5 mt-12 w-full leading-[100%] max-md:flex-wrap max-md:mt-10 max-md:max-w-full">
                                                ...
                                                <div className="justify-center p-2.5 my-auto text-base whitespace-nowrap rounded-xl bg-neutral-800 text-stone-200 max-md:px-5">
                                                    Balas
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex flex-col items-start px-6 pb-6 mt-6 text-2xl leading-6 rounded-xl bg-neutral-200 text-neutral-800 max-md:px-5 max-md:max-w-full">
                                            ...
                                            <img
                                                ...
                                                className="object-contain mt-6 w-full border-solid aspect-[100] border-[5px] border-neutral-200 stroke-[5px] stroke-neutral-200 max-md:max-w-full"
                                            />
                                            <div className="justify-center self-start p-2.5 mt-16 text-2xl leading-6 rounded-xl bg-neutral-800 text-stone-200 max-md:mt-10">
