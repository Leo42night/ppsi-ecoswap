        ...
        <div className="flex gap-5 max-md:flex-col max-md:gap-0">
          ...
          <form className="bg-white overflow-hidden shadow-sm rounded-lg p-10 flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-5 max-md:mt-10 max-md:max-w-full">
              <label htmlFor="dropzone-file" className="text-4xl max-md:max-w-full">
                Foto Limbah
              </label>
              ...
              <label htmlFor="nama-limbah" className="text-4xl max-md:max-w-full">
                Nama Limbah
              </label>
            ...
            <div className="flex flex-col gap-5 max-md:mt-10 max-md:max-w-full">
              ...
              <label htmlFor="harga-satuan" className="text-4xl max-md:max-w-full">
                Harga Satuan
              </label>
              <div className="relative">
            ...
            <div className="flex flex-col gap-5 max-md:mt-10 max-md:max-w-full">
              <label
                htmlFor="total-produk-yang-dijual"
                className="text-4xl max-md:max-w-full"
              >
