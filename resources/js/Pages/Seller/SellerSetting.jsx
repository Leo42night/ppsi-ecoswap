                                ...
                                <div className="max-md:max-w-full">
                                    <div className="flex flex-col grow shrink-0 self-end mt-12 basis-0 w-fit max-md:mt-10 max-md:max-w-full">
                                        ...
                                        <div className="flex flex-col items-start py-5 pr-20 max-md:pr-5">
                                            <div className="mt-12 text-2xl font-bold leading-8 text-neutral-700 max-md:mt-10 max-md:ml-2.5">
                                                Pengaturan Toko
                                            </div>
                                            <div className="flex justify-center items-center mt-6 max-md:px-5 max-md:max-w-full">
                                                <div className="flex flex-col w-full max-w-[1074px] max-md:max-w-full">
                                                    <div className="p-4 rounded-xl bg-zinc-400 max-md:px-5 max-md:max-w-full">
                                                        <div className="flex gap-4 max-md:flex-col max-md:gap-0">
                                                            <div className="flex flex-col w-[20%] max-md:ml-0 max-md:w-full">
                                                                <img
                                                                    loading="lazy"
                                                                    src="https://cdn.builder.io/api/v1/image/assets/TEMP/4d4a4c4d1f9f02aa1c7c05a38e31a71ef7da327b85ef92f146a55dabf587fdb3?apiKey=81aa3398288b425cae501e07d8c56af5&width=100"
                                                                    className="shrink-0 max-w-full shadow-lg aspect-square rounded-[200px] w-[100px] max-md:mt-6"
                                                                />
                                                            </div>
                                                            <div className="flex flex-col ml-2 w-[80%] max-md:ml-0 max-md:w-full">
                                                                <div className="flex flex-col pb-2 text-2xl font-bold leading-6 text-neutral-700 max-md:mt-6 max-md:max-w-full">
                                                                    <div>Nama Toko</div>
                                                                    <div className="mt-1 text-lg text-black">PT Angkasa Raya</div>
                                                                    <div className="mt-6">Domain Toko</div>
                                                                    <div className="mt-1 text-lg text-black">www.ecoswap.com/PTAngkasaRaya</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="flex flex-col py-4 pl-4 mt-4 text-2xl font-bold leading-6 rounded-xl bg-zinc-400 text-neutral-700 max-md:pl-4 max-md:max-w-full">
                                                        <div>Jam Operasional</div>
                                                        <div className="mt-1 text-sm text-black">09:00-21:00</div>
                                                        <div className="mt-6">Alamat</div>
                                                        <div className="flex gap-2 justify-center mt-1 text-sm text-neutral-800 max-md:flex-wrap">
                                                            <img
                                                                loading="lazy"
                                                                src="https://cdn.builder.io/api/v1/image/assets/TEMP/810ef39fdcbd99e8007da0311f2db3a3303e1c6b232e8c80c7ebb2bee31afe64?apiKey=81aa3398288b425cae501e07d8c56af5&"
                                                    ...
                                                    <div className="justify-center self-start px-4 py-1 mt-4 text-sm leading-5 text-white whitespace-nowrap rounded-xl bg-neutral-800 max-md:px-4">
                                                        Ubah
                                                    </div>
                                                </div>
                                            </div>

                                            <div className="flex flex-col self-center p-6 mt-6 w-full text-lg leading-7 rounded-xl bg-zinc-400 max-w-[1198px] text-neutral-700 max-md:px-5 max-md:max-w-full">
                                                <div className="text-2xl font-bold max-md:max-w-full">Slogan</div>
                                                ...
                                                <div className="justify-center self-start px-4 py-2.5 mt-8 text-white whitespace-nowrap rounded-xl bg-neutral-800 max-md:px-5 max-md:mt-6">
                                                    Simpan
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex flex-col items-start py-5 pr-20 max-md:pr-5">
                                            ...
                                            <div className="flex gap-4 justify-between mt-4 max-w-full text-lg whitespace-nowrap w-[100px]">
                                                <div className="justify-center px-4 py-2.5 text-white rounded-xl bg-neutral-800 max-md:px-5">
                                                    Indonesia
                                                </div>
                                        ...
                                        <div className="flex flex-col items-start py-5 pr-20 max-md:pr-5">
                                            <div className="flex gap-4 justify-between mt-4 max-w-full text-lg whitespace-nowrap w-[100px]">
                                                <div className="flex gap-4 justify-between mt-4 max-w-full text-lg w-[150px]">
                                                    ...
                                                    <div className="justify-center px-4 py-2.5 rounded-xl border-solid bg-neutral-800 border-[3px] border-neutral-800 text-neutral-200 max-md:px-5">
                                                        Tidak Aktif
                                                    </div>
                                                </div>
                                            </div>
