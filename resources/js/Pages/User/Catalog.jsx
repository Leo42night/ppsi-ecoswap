...
export default function Dashboard({ auth }) {
  return (
    <AuthenticatedLayout user={auth.user}>
      ...
      <div className="self-stretch bg-neutral-200 min-h-[12px]" />
      <div className="flex flex-col justify-center bg-white leading-[100%]">
        <div className="flex overflow-hidden relative flex-col items-end p-20 w-full min-h-[320px] max-md:px-5 max-md:max-w-full">
          ...
          <a href={route('ecodu')} className="relative justify-center px-6 py-3 mt-6 mb-3 text-base rounded-md bg-stone-200 text-neutral-800 max-md:px-5 max-md:mr-2.5">
            Lebih lanjut...
          </a>
        </div>
      </div>
      ...
      <div className="flex flex-col items-left px-20 py-11 max-md:px-5 bg-[#EEF0E5]">
        ...
        &nbsp;
        <a href={route('detail-produk-organic')} className="self-stretch">
      ...
      <a href={route('product-maps')} className="flex flex-col justify-center text-4xl font-medium leading-9 text-right bg-white text-stone-200">
          ...
          <div className="flex flex-col w-[32%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col self-stretch my-auto leading-[100%] max-md:mt-10 max-md:max-w-full">
              <div className="flex gap-3 font-semibold text-neutral-800 max-md:flex-wrap">
                ...
                <div className="text-base max-md:max-w-full mt-2 text-[#163020]">
                  Tertarik berjualan? Jadilah Penjual
                </div>
              </div>
              <div className="mt-6 text-base text-[#163020] max-md:max-w-full">
              ...
              <div className="flex gap-17 justify-between mt-6 text-base max-md:flex-wrap">
                <a href="/seller/register">
                  <button className="justify-center px-4 py-3 font-semibold text-white rounded-xl bg-[#163020] max-md:px-5">
                    Daftar Sekarang
                  </button>
                </a>
