        ...
        <>
            ...
            <div className="relative min-h-screen bg-gradient-to-t from-muted/55 to-transparent pt-5" style={{fontFamily: `sans-serif`}}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-screen">
                    ...
                    {/* main item */}
                    <br/>
                    <div class="flex gap-1 px-1 py-1 rounded-md bg-neutral-200 max-md:flex-wrap max-md:px-5 w-1/2">
                        <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/e81d3793d7f40718abcd760a5600627fbe7736a516ebf705e1b93ef68778ad27?apiKey=937261aeaab2482b817691a974988cbc&" alt="" class="shrink-0 w-6 aspect-square" />
                        <input class="my-auto grow border-none bg-transparent focus:outline-none outline-0 max-md:max-w-5" placeholder="Trying to find something" />
                    </div>
