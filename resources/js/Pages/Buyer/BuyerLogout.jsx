                ...
                <div className="flex max-md:flex-col max-md:gap-max">
                    ...
                    <div class="flex flex-col items-left p-max max-md:px-max w-full text-base leading-4 text-neutral-700 max-md:px-5 max-md:max-w-full">
                        <div class="flex flex-col max-md:max-w-full">
                            ...
                            <div className="flex flex-col self-stretch px-16 py-6 text-base leading-4 max-md:px-5">
                                ...
                                <div className="flex justify-end gap-2.5 pr-200 mt-6 max-md:flex-wrap max-md:pr-5">
                                    <div className="justify-center px-6 py-3 rounded-md border border-solid border-neutral-700 text-neutral-700 max-md:px-5">
                                        Batal
                                    </div>
                                    <div className="justify-center px-6 py-3 rounded-md bg-[#304D30] text-stone-200 max-md:px-5">
                                        Keluar
                                    </div>
                                </div>
                            </div>
