...
export default function Dashboard({ auth }) {
    return (
        ...
        >
            <div $name="Box" class="flex flex-col bg-[color:var(--Neat,#EEF0E5)]">
                <div class="flex justify-center items-center px-16 py-9 w-full bg-[color:var(--Neat,#EEF0E5)] leading-[100%] max-md:px-5 max-md:max-w-full">
                    <div class="flex gap-5 justify-between w-full max-w-[1680px] max-md:flex-wrap max-md:max-w-full">
                        <div class="flex gap-3 text-2xl text-[color:var(--Dark,#163020)]">
                            <img
                                ...
                                backgroundSize="auto"
                                class="relative shrink-0 w-[35px]"
                                aspectRatio={1.37}
                                noWebp={true}
                            />
                            <div class="my-auto not-italic">
                                <span class="font-bold">Eco</span>Swap
                            </div>
                        </div>
                        <div class="flex gap-5 justify-between my-auto text-base font-bold whitespace-nowrap">
                            <div class="flex flex-col justify-center px-6 py-3 not-italic rounded-md bg-[color:var(--Dark,#163020)] text-[color:var(--Neat,#EEF0E5)] max-md:px-5">
                                Masuk
                            </div>
                            <div class="flex flex-col justify-center px-6 py-3 not-italic rounded-md border-2 border-solid border-neutral-800 text-[color:var(--Dark,#163020)] max-md:px-5">
                                Daftar
                            </div>
                        </div>
                    </div>
                </div>
                <div class="flex gap-3 px-20 py-12 max-md:flex-wrap max-md:px-5">
                    ...
                    <div class="flex flex-col justify-center">
                        <div class="flex flex-col justify-center items-center px-6 w-16 h-16 rounded-md bg-[color:var(--More-Muted,#DFE4DF)] max-md:pl-5">
                            <img
                ...
                <div class="w-full bg-[color:var(--More-Muted,#DFE4DF)] min-h-[12px] max-md:max-w-full" />
                <div class="flex flex-col justify-center w-full text-right leading-[100%] text-[color:var(--Neat,#EEF0E5)] max-md:max-w-full">
                    <div class="flex flex-col justify-center w-full bg-[color:var(--More-Muted,#DFE4DF)] max-md:max-w-full">
                        <img
                            ...
                            class="flex overflow-hidden relative flex-col items-start px-12 pt-20 pb-12 w-full min-h-[560px] max-md:px-5 max-md:max-w-full"
                            aspectRatio={0.29}
                            noWebp={false}
                            fitContent={true}
                        >
                            <div class="flex relative flex-col px-12 py-6 mt-80 rounded-xl bg-[color:var(--Dark,#163020)] max-md:px-5 max-md:mt-10 max-md:max-w-full">
                                <div class="text-4xl not-italic font-semibold max-md:max-w-full">
                                    EcoDu Headline
                                </div>
                                <div class="mt-3 text-base not-italic max-md:max-w-full">
                ...
                <div class="flex flex-col px-20 py-12 w-full max-md:px-5 max-md:max-w-full">
                    ...
                    <div
                        class="mx-4 mt-6 max-md:mr-2.5 max-md:ml-0 max-md:max-w-full"
                        space={19}
                    >
                        <div width={25}>
                            <div class="flex flex-col grow leading-[100%] max-md:mt-6">
                                <img
                                    ...
                                    backgroundSize="cover"
                                    class="flex overflow-hidden relative flex-col justify-between px-3 py-6 w-full rounded-xl aspect-[1.78] text-[color:var(--Neat,#EEF0E5)]"
                                    aspectRatio={0.56}
                                    noWebp={false}
                                    fitContent={true}
                                >
                                    <div class="relative text-2xl not-italic font-semibold backdrop-blur-[2px]">
                                        PT Agantaratel
                                    </div>
                                    <div class="flex relative flex-col mt-28 text-right backdrop-blur-[2px] max-md:mt-10">
                                        <div class="text-2xl not-italic font-semibold">
                                            Rp 10.000/5 Kg
                                        </div>
                                        <div class="flex gap-1.5 px-20 mt-1.5 text-base max-md:px-5">
                                            <Image
                                                ...
                                                backgroundSize="auto"
                                                class="relative shrink-0 w-4"
                                                aspectRatio={1}
                                                noWebp={true}
                                            />
                                            <div class="not-italic">Sanggau, Kalimantan Barat</div>
                                        </div>
                                    </div>
                                </img>
                                <div class="mt-3 text-2xl not-italic font-bold text-[color:var(--Dark-Shade,#304D30)]">
                                    Kulit Telur
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="flex relative flex-col mt-28 text-right backdrop-blur-[2px] max-md:mt-10">
                                        ...
                                        <div class="flex gap-1.5 px-20 mt-1.5 text-base max-md:px-5">
                                            <Image
                                                ...
                                                noWebp={true}
                                            />
                                            <div class="not-italic">Ketapang, Kalimantan Barat</div>
                                        </div>
                                    </div>
                                </img>
                                <div class="mt-3 text-2xl not-italic font-bold text-[color:var(--Dark-Shade,#304D30)]">
                        ...
                        <div width={25}>
                            <div class="flex flex-col grow leading-[100%] max-md:mt-6">
                                ...
                                >
                                    ...
                                    <div class="flex relative flex-col mt-28 text-right backdrop-blur-[2px] max-md:mt-10">
                                        <div class="text-2xl not-italic font-semibold">Rp 5.000/1 Kg</div>
                                        <div class="flex gap-1.5 px-20 mt-1.5 text-base max-md:px-5">
                                            <img
                                                src="https://cdn.builder.io/api/v1/image/assets/TEMP/99d15ee3f9b108876e323ac5d343266e371559790daef7b64cbcbb3fd6dfcb89?placeholderIfAbsent=true"
                                                backgroundSize="auto"
                                                ...
                                                noWebp={true}
                                            />
                                            <div class="not-italic">Pontianak, Kalimantan Barat</div>
                                        </div>
                                    </div>
                                </img>
                                <div class="mt-3 text-2xl not-italic font-bold text-[color:var(--Dark-Shade,#304D30)]">
                                    ...
                                    <div class="flex relative flex-col mt-28 text-right backdrop-blur-[2px] max-md:mt-10">
                                        ...
                                        <div class="flex gap-1.5 px-20 mt-1.5 text-base max-md:px-5">
                                            <img
                                                ...
                                                noWebp={true}
                                            />
                                            <div class="not-italic">Landak, Kalimantan Barat</div>
                                        </div>
                                    </div>
                                </img>
                                <div class="mt-3 text-2xl not-italic font-bold text-[color:var(--Dark-Shade,#304D30)]">
                ...
                <div
                    $name="Box"
                    class="flex flex-col px-20 py-12 w-full max-md:px-5 max-md:max-w-full"
                >
                    <div class="mx-4 text-4xl not-italic font-semibold leading-10 text-[color:var(--Dark,#163020)] max-md:mr-2.5 max-md:ml-0 max-md:max-w-full">
                        Limbah Anorganik
                    </div>
                ...
                <div class="w-full bg-[color:var(--More-Muted,#DFE4DF)] min-h-[12px] max-md:max-w-full" />
                <div class="flex flex-col px-20 py-12 w-full bg-[color:var(--Dark,#163020)] leading-[100%] max-md:px-5 max-md:max-w-full">
                    <div class="flex flex-col justify-center py-6 mx-4 text-[color:var(--Neat,#EEF0E5)] max-md:mr-2.5 max-md:ml-0 max-md:max-w-full">
                        <div class="flex gap-3 max-md:flex-wrap">
                            <div class="flex-1 my-auto text-2xl not-italic font-semibold max-md:max-w-full">
                                Seseorang Mencari Limbah
                            </div>
                            <div class="flex flex-col justify-center px-6 py-3 text-base not-italic rounded-xl border-2 border-solid border-neutral-200 max-md:px-5">
                    ...
                    <div class="flex overflow-x-auto flex-col justify-center mx-4 mb-12 text-base font-semibold text-[color:var(--Dark,#163020)] max-md:mr-2.5 max-md:mb-10 max-md:ml-0 max-md:max-w-full">
                        <div class="flex z-10 gap-5 justify-between -mb-32 max-md:flex-wrap max-md:mb-2.5">
                            <div class="flex gap-5 p-6 rounded-xl bg-[color:var(--More-Muted,#DFE4DF)] max-md:flex-wrap max-md:px-5">
                                <img
                                    ...
                                    backgroundSize="auto"
                                    class="relative shrink-0 self-start w-12"
                                    aspectRatio={1}
                                    noWebp={false}
                                />
                                <div class="flex flex-col flex-1 max-md:max-w-full">
                                    <div class="not-italic max-md:max-w-full">Rina Akrina</div>
                                    <div class="mt-3 text-2xl not-italic max-md:max-w-full">
                                        Kardus Bekas
                                    </div>
                                    <div class="mt-3 not-italic max-md:max-w-full">
                            ...
                            <div class="flex gap-5 p-6 rounded-xl bg-[color:var(--More-Muted,#DFE4DF)] max-md:flex-wrap max-md:px-5">
                                ...
                                />
                                <div class="flex flex-col flex-1 max-md:max-w-full">
                                    <div class="not-italic max-md:max-w-full">Amely11</div>
                                    <div class="mt-3 text-2xl not-italic max-md:max-w-full">
                                        Kantong Plastik
                                    </div>
                                    <div class="mt-3 not-italic max-md:max-w-full">
                            ...
                            <div class="flex gap-5 p-6 rounded-xl bg-[color:var(--More-Muted,#DFE4DF)] max-md:flex-wrap max-md:px-5">
                                ...
                                />
                                <div class="flex flex-col flex-1 max-md:max-w-full">
                                    <div class="not-italic max-md:max-w-full">Wiry Agustin</div>
                                    <div class="mt-3 text-2xl not-italic max-md:max-w-full">
                                        Tutup Botol Kaleng
                                    </div>
                                    <div class="mt-3 not-italic max-md:max-w-full">
                            ...
                            <div class="flex gap-5 p-6 rounded-xl bg-[color:var(--More-Muted,#DFE4DF)] max-md:flex-wrap max-md:px-5">
                                ...
                                />
                                <div class="flex flex-col flex-1 max-md:max-w-full">
                                    <div class="not-italic max-md:max-w-full">User Name</div>
                                    <div class="mt-3 text-2xl not-italic max-md:max-w-full">
                                        Waste Name
                                    </div>
                                    <div class="mt-3 not-italic max-md:max-w-full">
                            ...
                            <div class="flex z-10 gap-5 p-6 rounded-xl bg-[color:var(--More-Muted,#DFE4DF)] max-md:flex-wrap max-md:px-5">
                                <img
                ...
                <div class="w-full bg-[color:var(--More-Muted,#DFE4DF)] min-h-[12px] max-md:max-w-full" />
                <div class="px-20 py-12 w-full max-md:px-5 max-md:max-w-full" space={38}>
                    <div width={31.801909307875896}>
                        <div class="flex flex-col self-stretch my-auto leading-[100%] max-md:mt-10 max-md:max-w-full">
                            <div class="flex gap-3 font-semibold text-[color:var(--Dark,#163020)] max-md:flex-wrap">
                                <div class="text-2xl not-italic">EcoSeller’s</div>
                                <div class="flex-1 text-base not-italic">
                                    Tertarik untuk berjualan? Jadilah Penjual
                                </div>
                            </div>
                            <div class="mt-6 text-base not-italic text-[color:var(--Dark,#163020)] max-md:max-w-full">
                            ...
                            <div class="flex gap-5 justify-between mt-6 text-base max-md:flex-wrap">
                                <div class="flex flex-col justify-center px-6 py-3 not-italic font-semibold text-white rounded-xl bg-[color:var(--Dark,#163020)] max-md:px-5">
                                    Daftar Sekarang
                                </div>
                                <div class="my-auto not-italic text-[color:var(--Dark,#163020)]">
                                    Selengkapnya
                                </div>
                            </div>
                        </div>
                    ...
                    <div width={68.1980906921241}>
                        <div class="flex flex-col grow justify-center w-full text-2xl font-bold leading-6 whitespace-nowrap rounded-xl bg-[color:var(--Muted,#B6C4B6)] text-stone-200 max-md:mt-10 max-md:max-w-full">
                            <img
                                ...
                                backgroundSize="cover"
                                class="flex overflow-hidden relative justify-center items-center px-16 py-20 w-full min-h-[265px] max-md:px-5 max-md:max-w-full"
                                aspectRatio={0.23}
                                noWebp={false}
                                fitContent={true}
                            >
                                <div class="flex relative gap-3 mt-5 mb-5">
                                    <img
                                        ...
                                        backgroundSize="auto"
                                        class="relative shrink-0 w-[46px]"
                                        aspectRatio={1.39}
                                        noWebp={true}
                                    />
                                    <div class="my-auto not-italic">EcoSell</div>
                                </div>
                            </img>
                        </div>
                    </div>
                ...
                <div class="w-full bg-[color:var(--More-Muted,#DFE4DF)] min-h-[12px] max-md:max-w-full" />
                <div class="flex gap-0 justify-between items-start px-20 py-12 text-base leading-4 bg-[color:var(--Neat,#EEF0E5)] text-neutral-600 max-md:flex-wrap max-md:px-5">
                    <div class="flex flex-col flex-1 self-stretch">
                        <div class="text-2xl not-italic font-semibold text-[color:var(--Dark,#272727)]">
                            Kategori
                        </div>
                        <div class="mt-3 not-italic">Limbah Kulit Buah</div>
                        <div class="mt-3 not-italic">Limbah Elektronik</div>
                        <div class="mt-3 not-italic">Limbah Plastik</div>
                        <div class="mt-3 not-italic">Limbah Kain</div>
                        <div class="mt-3 not-italic">Limbah Kaca</div>
                        <div class="mt-3 not-italic">Limbah Minyak Jelatah</div>
                        <div class="mt-3 not-italic">Limbah Kayu</div>
                        <div class="mt-3 not-italic">Limbah Styrofoam</div>
                        <div class="mt-3 not-italic">Limbah Besi</div>
                        <div class="mt-3 not-italic">Kompos</div>
                    </div>
                    <div class="flex flex-col flex-1">
                        <div class="text-2xl not-italic font-semibold text-[color:var(--Dark,#272727)]">
                            Tentang
                        </div>
                        <div class="mt-3 not-italic">Cerita Kami</div>
                        <div class="mt-3 not-italic">Pers & Berita</div>
                        <div class="mt-3 not-italic">Mitra</div>
                        <div class="mt-3 not-italic">Kebijakan Privasi</div>
                        <div class="mt-3 not-italic">Relasi Investor</div>
                    </div>
                    <div class="flex flex-col flex-1">
                        <div class="text-2xl not-italic font-semibold text-[color:var(--Dark,#272727)]">
                            Dukungan
                        </div>
                        <div class="mt-3 not-italic">Bantuan & Dukungan</div>
                        <div class="mt-3 not-italic">Kepercayaan & Keamanan</div>
                        <div class="mt-3 not-italic">Menjual di EcoSwap</div>
                        <div class="mt-3 not-italic">Pembelian di EcoSwap</div>
                    </div>
                    <div class="flex flex-col flex-1 self-stretch">
                        <div class="text-2xl not-italic font-semibold text-[color:var(--Dark,#272727)]">
                            Komunitas
                        </div>
                        <div class="mt-3 not-italic">Kisah Sukses Pelanggan</div>
                        <div class="mt-3 not-italic">Pusat Komunitas</div>
                        <div class="mt-3 not-italic">Forum</div>
                        <div class="mt-3 not-italic">Acara</div>
                        <div class="mt-3 not-italic">Blog</div>
                        <div class="mt-3 not-italic">Pemberi pengaruh</div>
                        <div class="mt-3 not-italic">Afiliasi</div>
                        <div class="mt-3 not-italic">Podcast</div>
                        <div class="mt-3 not-italic">Menjadi Penjual</div>
                        <div class="mt-3 not-italic">Standar Komunitas</div>
                    </div>
                    <div class="flex flex-col flex-1">
                        <div class="text-2xl not-italic font-semibold text-[color:var(--Dark,#272727)]">
                            Lainnya dari EcoSwap
                        </div>
                        <div class="mt-3 not-italic">Pendidikan EcoSwap</div>
                        <div class="mt-3 not-italic">Postingan EcoSwap</div>
                        <div class="mt-3 not-italic">Dapatkan Inspirasi</div>
                    </div>
                </div>
                <div class="flex justify-center items-center px-16 py-12 w-full text-base leading-4 text-black bg-[color:var(--Neat,#EEF0E5)] max-md:px-5 max-md:max-w-full">
                    <div class="flex gap-5 justify-between">
                        <img
                            ...
                            backgroundSize="auto"
                            class="relative shrink-0 w-[47px]"
                            aspectRatio={1.36}
                            noWebp={true}
                        />
                        <div class="my-auto not-italic">EcoSwap Copyright 2024</div>
                    </div>
                </div>
            </div>
        </AuthenticatedLayout>
