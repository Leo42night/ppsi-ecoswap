      ...
      <div class="flex flex-col justify-center bg-[#EEF0E5]">
        <div class="w-full max-md:max-w-full">
          <div class="flex gap-5 max-md:flex-col max-md:gap-0">
            ...
            <div class="flex flex-col grow p-12 w-full bg-[#EEF0E5] leading-[100%] max-md:px-5 max-md:max-w-full">
              <div class="text-2xl font-semibold text-black max-md:max-w-full">
                Log Out
              </div>
              <div class="flex flex-col px-16 py-6 mt-6 text-base max-md:px-5 max-md:max-w-full">
                <div class="text-2xl text-black max-md:max-w-full">
                  Anda akan keluar dari akun
                </div>
                <div class="mt-6 text-black max-md:max-w-full">
                  Anda yakin keluar dari akun?
                </div>
                <div class="flex gap-5 pl-20 mt-6 whitespace-nowrap max-md:flex-wrap max-md:pl-5">
                  <div class="flex justify-end gap-10 mt-6 whitespace-nowrap max-md:flex-wrap max-md:pl-5">
                    <div class="px-6 py-4 rounded-md border-2 border-solid border-neutral-700 text-neutral-700 max-md:px-5">
                      Batal
                    </div>
                    <div class="px-6 py-4 rounded-md bg-[#304D30] text-white max-md:px-5 border-2">
                      Keluar
                    </div>
                  </div>
                </div>
